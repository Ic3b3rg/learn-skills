...
4. **Write the file** at `learn/<slug>-exercises.md` using the format below.
...
- **E4 — Debug.** Given a deliberately broken version, find and fix the bug. **Include this in code-mode** — debug exercises produce the highest transfer signal.
