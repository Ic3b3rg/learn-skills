...
- Typical skills: connect-to-what-you-know (anchor to prior knowledge), quiz-me (after study), learn-by-doing (apply on a contrived problem), explain-and-check (in topic mode), linked-notes / flashcards (capture).
